...
- **Codex:** arquitecto/CTO, escribe todo el código y SQL. Diseña sistemas y razona decisiones.
- **Cowork/Codex:** edita archivos localmente. **NUNCA toca `.git/`** — git lo corre Benjamin desde su Mac terminal.
