...
export default function GroupRightSidebar({ groupId, maxStock }: Props) {
  ...
  return (
    <aside className="w-[280px] flex-shrink-0 sticky top-[80px] space-y-4">
      ...
      <div className="bg-white rounded-2xl border border-neutral-100 p-5">
        <h3 className="text-xs font-bold text-neutral-900 uppercase tracking-wide mb-3">¿Por qué unirte?</h3>
        <ul className="space-y-2.5">
          {['Aseguras tu unidad','Siempre pagarás el mejor precio conseguido','Cada nuevo comprador ayuda a bajar el precio','Pago seguro con Stripe'].map(text => (
