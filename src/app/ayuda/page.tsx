...
const FAQS = [
  ...
  { q: '¿Qué pasa si el grupo no llega al objetivo?', a: 'No pasa nada malo: se libera tu retención automáticamente y no se realiza ningún cargo. Es la garantía de Vonda — si no hay grupo, no hay pago.' },
  ...
  { q: '¿Es seguro el pago?', a: 'Sí. Los pagos se gestionan a través de Stripe, líder mundial en pagos. Vonda no almacena los datos de tu tarjeta.' },
]
      ...
      <div className="flex-1 min-w-0 flex flex-col pb-24 lg:pb-0">
        <main className="w-full max-w-[760px] px-4 lg:px-10 pt-6 lg:pt-10 pb-14">
          ...
          <p className="text-center text-[13px] text-neutral-400 mt-8">
            ¿Nuevo en Vonda? <Link href="/como-funciona" className="text-brand font-semibold">Descubre cómo funciona</Link>
          </p>
        </main>
      </div>
