...
export default async function UnirmePage({
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      {/* A-32 · 512 px centrados en una pantalla de 1.440 no eran una decisión de
          diseño, eran la ausencia de una. En escritorio el contenedor se ensancha y
          JoinFlow lo reparte en dos columnas. */}
      <div className="mx-auto min-h-screen max-w-md bg-white pb-52 lg:max-w-[1040px] lg:px-8 lg:pb-10">

        {/* ── CABECERA: marca + pago seguro 3D Secure ── */}
        <header className="sticky top-0 z-20 flex h-14 items-center justify-between border-b border-neutral-100 bg-white/95 px-4 backdrop-blur lg:h-16 lg:px-0">
          <Link
            href={`/grupo/${v.id}`}
